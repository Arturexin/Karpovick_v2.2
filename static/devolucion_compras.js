    ...
    devolucionesComprobante.forEach((event) => {
        if(event.comprobante.toLowerCase() === document.getElementById('buscador-comporbante-compras').value.toLowerCase()){
            ...
            let fila = `<tr>
                            ...
                            <td class="codigoDevoluciones" style="background: rgb(105, 211, 35); border-radius: 5px">${event.codigo}</td>
                            <td  style="text-align: right">${event.existencias_entradas}</td>
                            <td><input class="cantidadADevolver input-tablas-dos-largo"></td>
